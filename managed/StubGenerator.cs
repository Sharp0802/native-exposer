...
public class StubGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        {
            // do NOT change `_handle` to other name; It's used by native stub generator
                ...
                $$"""
                  ...
                  namespace {{Namespace}} {
                      ...
                      public static class Internal {
                          ...
                          public static void Free(IntPtr _handle) {
                              System.Runtime.InteropServices.GCHandle.FromIntPtr(_handle).Free();
                          }
                      }
                  }
                  """);
